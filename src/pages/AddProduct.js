...
export default function AddProduct() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-4 sm:p-6 rounded shadow-md">
      <h2 className="text-xl sm:text-2xl font-semibold mb-4">Add Product</h2>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="col-span-1 sm:col-span-2">
          <button
            type="submit"
            className="w-full sm:w-auto sm:ml-auto block bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700"
          >
            Upload Product
          </button>
        </div>
