...
const Footer = () => {
  ...
  return (
    // pt-10 → pt-6: less dead air before the social/subscribe row even starts.
    <footer className="bg-gradient-to-r from-gray-800 to-gray-700 text-white pt-5 pb-1 px-6">
      <div className="max-w-7xl mx-auto">

        {/* Top Row — mb-8 → mb-6: tightens the gap before the main grid below. */}
        ...
        {/* Main Footer Grid — mb-10 → mb-6: this was the biggest single
            contributor to the gap you saw above the bottom border line. */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-3 items-start">
          {/* About */}
        ...
        {/* Bottom — pt-4 → pt-3: tighter gap between the border line and
            the copyright text itself. */}
        <div className="border-t border-gray-700 pt-2 text-center text-sm text-gray-400">
